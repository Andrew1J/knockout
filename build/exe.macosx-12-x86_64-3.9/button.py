...
class Button(pygame.sprite.Sprite):
    ...
    def draw(self,cursor_x,cursor_y):
        ...
        if cursor_x > self.pos_x - self.BUTTON_WIDTH/2 and cursor_x < self.pos_x + self.BUTTON_WIDTH/2 and cursor_y > self.pos_y - self.BUTTON_HEIGHT/2 and cursor_y <  self.pos_y + self.BUTTON_HEIGHT/2:
